...
curl -L --max-redirs 5 --output "$TEMP_DIR/GaN_holographic_focal_series.zip" https://depositonce.tu-berlin.de/bitstream/11303/7448/2/GaN_holographic_focal_series.zip
